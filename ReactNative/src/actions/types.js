...
export const RAISE_AMOUNT_RESPONSE = 'raise_amount_response'
export const DRAW_AMOUNT_RESPONSE = 'draw_amount_response'
export const TURN_VALUE_RESPONSE = 'turn_value-response'
export const WINNING_CARDS = 'winning_cards'
